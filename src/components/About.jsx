    ...
    >
      <div className="max-w-screen p-4 mx-auto flex flex-col justify-center w-full h-full ">
        ...
        <p className="text-xl ">
          ...
          Nigeria. I have developed various types of frontend Application,
          ranging from an Admin dashboard; where I implemented CRUD(Create,
          Read, Upadate, and Delete) functionalities on it. I have also worked
          on an E-commerce website for buyers and sellers. I am passionate about
        ...
        <p className="text-xl ">
          ...
          <ul className=" mt-10  list-disc text-xl">
